...
const Modal = ({id, header, body, footer, onClose}) => {
  return (
    <div className='text-black text-2xl fixed z-1 pt-6 left-0 top-0 w-full h-full overflow-auto  flex justify-center items-center' id={id || "Modal"}>
        <div className='relative bg-stone-300 m-auto p-10 border flex flex-col justify-center items-center border-red-800 rounded-md w-[80%]'>
